...
# === Share-Ergebnis optimiert ===
if antwort:
    st.write("📢 **Teile dein Rohgang-Ergebnis:**")
    st.text_area("Klicke hier zum Kopieren:", value=antwort, height=80)
    st.markdown("🔗 **Kopiere den Text oben und teile ihn auf Instagram oder X!**")
